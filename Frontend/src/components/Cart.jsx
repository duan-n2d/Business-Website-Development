...
function Checkbox({ isChecked, handleCheckboxChange }) {
  return (
...
function CartItem({ product, onIncrement, onDecrement, onDelete }) {
  const { image, name, price, quantity, isChecked } = product;

  return (
    <div className="flex justify-center items-center max-w-[915px] max-[800px]:mx-[5px]">
      <div className="flex items-center w-1/2">
        <Checkbox
          isChecked={isChecked}
          handleCheckboxChange={() => {}}
        />
        <img src={image} className="h-20 w-auto ml-[10px]" />
