...
const Footer = () => {
  const trustItems = [
    {
      icon: <PiHouseLineFill className="w-20 h-20 mx-auto mb-2" />,
      description: ["Ngôi Nhà Âm Nhạc"],
    },
    {
      icon: <PiTruckFill className="w-20 h-20 mx-auto mb-2" />,
      description: ["Giao Hàng Miễn Phí", "Đảm Bảo Vận Chuyển"],
    },
    {
      icon: <PiShoppingCartFill className="w-20 h-20 mx-auto mb-2" />,
      description: ["Mua Sắm Trực Tuyến", "Đảm Bảo An Toàn"],
    },
    {
      icon: <PiTagFill className="w-20 h-20 mx-auto mb-2" />,
      description: ["Đơn Giá Đã Bao Gồm Các Khoản Thuế"],
    },
  ];
  const contactInfo = [
    {
      ...
      detail:
        "Số 669 Quốc lộ 1A, Khu phố 3, phường Linh Xuân, TP Thủ Đức, TP Hồ Chí Minh",
      url: null,
    },
    {
      ...
      <div className="flex-col justify-center">
        ...
        <div className=" w-full lg:w-10/12 mx-auto grid grid-cols-1 sm:grid-cols-2 sm:gap-2 md:grid-cols-4 md:gap-2">
          ...
          <div className="py-5 px-2">
            <div className="text-center font-bold text-red-500 text-[22px] my-2">
              THÔNG TIN LIÊN HỆ
            </div>
              ...
              {contactInfo.map((contact, index) => (
                <div key={index} className="flex items-center my-1">
                  <a href={contact.url} className="flex">
                    <div className="mr-2">
                      <div className="rounded-full bg-gray-800 text-white p-1">
                        {contact.icon}
                      </div>
                    </div>
          ...
          <div className="py-5 px-2">
            <div className="font-bold text-red-500 text-[22px] my-2">
            ...
            <div className="ml-2 mt-3 w-full flex justify-center">
              <div className="mx-auto">
                <ul className="list-support">
                  <li className="pb-2">
                    <a href="#">
                      <p className="border-black border-0 p-2 text-center font-semibold rounded-md bg-green-200">
                        Đăng ký &rarr;
                      </p>
                    </a>
                  </li>
